...
public class TaskListImpl implements TaskList {
    ...
    public Task createTask(CalendarDate startDate, CalendarDate endDate, String text, int points, long effort, String description, String parentTaskId) {
        ...
        el.addAttribute(new Attribute("points", String.valueOf(points)));
