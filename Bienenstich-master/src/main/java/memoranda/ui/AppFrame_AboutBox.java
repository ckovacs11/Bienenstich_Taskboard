...
/**
* Class representing an About Box
*/
public class AppFrame_AboutBox extends JDialog implements ActionListener {
  ...
  String copyright = "SER316 Spring 2020";
  String url = App.WEBSITE_URL;
  String bienenstichHead = Local.getString("Bienenstich") + ":";
  String[] bienenstich = {
    "Alexandra Hollingsworth (ahollin5)",
    "Curtis Kovacs (ckovacs1)",
    "Demarco Young (dryoung9)",
    "Kacie Moden (kmoden1)",
    "Steven Faye (srfaye)"
  };
  String developersHead = Local.getString("Memoranda Devs") + ":";
  String[] developers = {
  ...
  private void jbInit() throws Exception  {
    ...
    text += "<b>" + bienenstichHead + "</b><br>";
    for (int i = 0; i < bienenstich.length; i++)
        text += bienenstich[i]+"<br>";
    text += "<br><b>" + developersHead + "</b><br>";
    for (int i = 0; i < developers.length; i++)
        text += developers[i]+"<br>";

    text += "</html>";

    image = new ImageIcon(AppFrame_AboutBox.class.getResource("/ui/bienenstich_info.png"));
    this.setTitle(Local.getString("About Bienenstich Scrum Board"));
    setResizable(false);
    // Initialize Objects
