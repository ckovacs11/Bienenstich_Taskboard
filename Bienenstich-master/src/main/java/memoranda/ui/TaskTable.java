...
public class TaskTable extends JTable {
    ...
    public TaskTable() {
        ...
        CurrentProject.addProjectListener(new ProjectListener() {
            ...
            public void projectChange(Project p, NoteList nl, TaskList tl, TaskboardList tbl, 
                    ResourcesList rl, SprintList spr1, TeamList teal, BacklogList back1) {
    ...
    private void initTable() {
		...
		//Bienenstich: we don't need the tasks sorted by progress/priority
    ...
    //Set the userstory, task, assigned-to, and points column widths
