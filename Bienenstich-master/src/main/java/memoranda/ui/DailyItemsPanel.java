...
//    JSplitPane splitPane = new JSplitPane(); parent of calendar and mainPanel
    ...
    // bienenstich panels
    BacklogPanel backlogPanel = new BacklogPanel(this);
    SprintPanel sprintPanel = new SprintPanel(this);
    TaskboardPanel taskboardPanel = new TaskboardPanel(this);
...
//        splitPane.setDividerSize(2);
        ...
        currentDateLabel.setFont(new java.awt.Font("Dialog", Font.ITALIC, 18));
...
//        cmainPanel.setBackground(SystemColor.desktop);
        cmainPanel.setBackground(Color.pink);
        ...
        // green checkbox button showing active tasks
        ...
        // adding the mainPanel instead of splitPanel removes the calendar from all tabs
...
//        controlPanel.add(cmainPanel, BorderLayout.CENTER);
        ...
        // add the editors to the editorsPanel
        editorsPanel.add(backlogPanel, "BACKLOG");
        editorsPanel.add(sprintPanel, "SPRINT");
        editorsPanel.add(taskboardPanel, "TASKBOARD");
        editorsPanel.add(teamPanel, "TEAM");
        editorsPanel.add(eventsPanel, "EVENTS");
        editorsPanel.add(tasksPanel, "TASKS");
        editorsPanel.add(editorPanel, "NOTES"); //add notes panel to left side panel

//        workPane.add(mainPanel, JSplitPane.RIGHT);
...
//            	Util.debug("current project is " + CurrentProject.get().getTitle());
            	...
            	currentProjectChanged(p, nl, tl, rl, teal);
            }
...
//		Util.debug("currentNoteChanged");
    ...
    void currentProjectChanged(Project newprj, NoteList nl, TaskList tl, ResourcesList rl, TeamList teal) {
...
//            splitPane.setDividerLocation((int) controlPanel.getPreferredSize().getWidth());
    ...
    /**
     * selects the panel to be displayed
     * @param pan String representing panel to be displayed
     */
	...
	// set the action events for green task checkbox and alarm checkbox
