...
/*                        _doc = new Document(_root);
        ...
        public boolean export(String src){
                ...
                File file = new File(this.name+"."+src);
                        ...
                        fwrite.close();
                        JOptionPane.showMessageDialog(null,Local.getString("Documento created successfully in your Memoranda folder =D"));
            
            
        } catch (IOException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,Local.getString("We did NOT manage to create your document =(..."));
        }
