...
/*
* TaskPanel should be mostly left alone, this code has been copied to a new
* TaskboardPanel.java file for modifying into a scrum board.
*/
...
//			new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_remove.png")));
    ...
    */
    ...
    void editTaskB_actionPerformed(ActionEvent e) {
        ...
        dlg.pointsCombobox.setSelectedIndex(t.getPoints());
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
        ...
        t.setPoints(dlg.pointsCombobox.getSelectedIndex());
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
		...
		Task newTask = CurrentProject.getTaskList().createTask(sd, ed, dlg.todoField.getText(), dlg.pointsCombobox.getSelectedIndex(),effort, dlg.descriptionField.getText(),null);
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
 		...
 		if(dlg.chkEndDate.isSelected())
 			...
 			ed = null;
        long effort = Util.getMillisFromHours(dlg.effortField.getText());
		Task newTask = CurrentProject.getTaskList().createTask(sd, ed, dlg.todoField.getText(), dlg.pointsCombobox.getSelectedIndex(),effort, dlg.descriptionField.getText(),parentTaskId);
        newTask.setProgress(((Integer)dlg.progress.getValue()).intValue());
//		CurrentProject.getTaskList().adjustParentTasks(newTask);
