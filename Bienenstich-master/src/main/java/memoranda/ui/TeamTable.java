...
public class TeamTable extends JTable {
    ...
    public static final int TEAM_ID = 100;

    public static final int TEAM = 101;

    public static final int TEAM_NAME = 102;

    protected TreeTableCellRenderer tree;

    protected TeamTableModel model;

    protected TreeTableModelAdapter modelAdapter;

    protected TeamTreeTableCellRenderer renderer;
    ...
    public TeamTable() {
        ...
        CurrentProject.addProjectListener(new ProjectListener() {
           public void projectChange(Project p, NoteList nl, TaskList tl, TaskboardList tbl, ResourcesList rl, 
                   SprintList sprl, TeamList teal, BacklogList back1) {
            }
    ...
    private void initTable() {
        ...
        model = new TeamTableSorter( this );
        ...
        renderer = new TeamTreeTableCellRenderer(this);


        tree.setCellRenderer(renderer);
        setDefaultRenderer(TreeTableModel.class, tree);
        setDefaultRenderer(Integer.class, renderer);
        setDefaultRenderer(TeamTable.class, renderer);
...
//        model.fireUpdateCache();
    ...
    public class TreeTableCellRenderer extends JTree implements // {{{
        ...
        public void setRowHeight(int rowHeight) {
            if (rowHeight > 0) {
                super.setRowHeight(rowHeight);
                if (TeamTable.this != null
                        && TeamTable.this.getRowHeight() != rowHeight) {
                    TeamTable.this.setRowHeight(getRowHeight());
                }
            }
        }
        ...
        public void setBounds(int x, int y, int w, int h) {
            super.setBounds(x, 0, w, TeamTable.this.getHeight());
        }
